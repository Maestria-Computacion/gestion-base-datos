...
CREATE TABLE IF NOT EXISTS configuracion_reporte_financiero (
    ...
    biblioteca DECIMAL(12,2) NOT NULL COMMENT 'Costo fijo por estudiante',
    recursos_computacionales DECIMAL(12,2) NOT NULL COMMENT 'Costo fijo por estudiante',
...
CREATE TABLE IF NOT EXISTS configuracion_reporte_grupos (
    ...
    excedentes_maestria DECIMAL(12,2) DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS participacion_grupo (
    ...
    vigencias_anteriores DECIMAL(12,2) DEFAULT 0.00,
    PRIMARY KEY (id),
